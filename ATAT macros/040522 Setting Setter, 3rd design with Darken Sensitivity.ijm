...
// Adding fibrotic lines option for ATAT v1.1.8
Dialog.addChoice("Fibrotic lines", newArray("Display", "Hide"), PrevFibroticLines);
...
FibroticLines = Dialog.getChoice();
...
Table.set("Fibrotic Lines", 0, FibroticLines);
