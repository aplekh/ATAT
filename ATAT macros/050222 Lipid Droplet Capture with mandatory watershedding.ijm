...
if (SettingsStatus == 0) {
	OutputDir = getDirectory("imagej") + "PATTI/";
...
FibrosityCaptureSettings = Table.getString("Fibrosity Capture Settings", 0);
...
run("Invert");
runMacro("050222 Watershed Circles");
run("Invert");
...
if (AdipocyteResults == "Display and Save Results") {
...
if (FibrosityCaptureSettings == "Capture Only") {
